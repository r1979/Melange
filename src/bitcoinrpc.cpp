...
{ //  name                      actor (function)         okSafeMode threadSafe
  //  ------------------------  -----------------------  ---------- ----------
    ...
    { "minespice",              &setgenerate,            true,      false },
...
//
// JSON-RPC protocol.  Spice speaks version 1.0 for maximum compatibility,
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use spiced";
...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "minespice"              && n > 1) ConvertTo<boost::int64_t>(params[1]);
    if (strMethod == "minespice"              && n > 0) ConvertTo<bool>(params[0]);
